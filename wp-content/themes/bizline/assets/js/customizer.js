  ...
  jQuery(document).ready(function ($) {
    ...
    $('.alpha-color-control').each(function () {
      ...
      colorPickerOptions = {
        ...
        palettes: bizlineColorPalette.colorPalettes // Use the passed in palette.
...
wp.customize.controlConstructor['range'] = wp.customize.Control.extend({
  ready: function ready() {
    ...
    var control = this,
        ...
        input_default,
        changeAction,
        bizline_range_input_number_timeout; // Update the text value
    ...
    function autocorrect_range_input_number(input_number, timeout) {
      ...
      clearTimeout(bizline_range_input_number_timeout);
      bizline_range_input_number_timeout = setTimeout(function () {
        if (isNaN(value)) {
