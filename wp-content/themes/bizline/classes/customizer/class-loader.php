...
class Bizline_Customizer_Loader extends Bizline_Helper{
	...
	public static function script(){
		...
		wp_localize_script( self::with_prefix( 'customize-js' ), 'bizlineColorPalette',
			array( 
				'colorPalettes' => array(
					'#000000',
					'#ffffff',
