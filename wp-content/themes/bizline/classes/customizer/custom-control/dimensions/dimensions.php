...
class Bizline_Customizer_Dimensions_Control extends WP_Customize_Control {
	...
	public function to_json() {
		...
		$this->json['title'] 	= esc_html__( 'Link values together', 'bizline' );
	...
	protected function l10n( $id = false ) {
		$translation_strings = array(
			'desktop_top' 		=> esc_html__( 'Top', 'bizline' 	),
			'desktop_right' 	=> esc_html__( 'Right', 'bizline' 	),
			'desktop_bottom' 	=> esc_html__( 'Bottom', 'bizline' ),
			'desktop_left' 		=> esc_html__( 'Left', 'bizline' 	),
			'tablet_top' 		=> esc_html__( 'Top', 'bizline' 	),
			'tablet_right' 		=> esc_html__( 'Right', 'bizline' 	),
			'tablet_bottom' 	=> esc_html__( 'Bottom', 'bizline' ),
			'tablet_left' 		=> esc_html__( 'Left', 'bizline' 	),
			'mobile_top' 		=> esc_html__( 'Top', 'bizline' 	),
			'mobile_right' 		=> esc_html__( 'Right', 'bizline' 	),
			'mobile_bottom' 	=> esc_html__( 'Bottom', 'bizline' ),
			'mobile_left' 		=> esc_html__( 'Left', 'bizline' 	),
		);
		if ( false === $id ) {
