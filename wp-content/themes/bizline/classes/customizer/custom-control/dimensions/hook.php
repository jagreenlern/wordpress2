...
if( !class_exists( 'Bizline_Customizer_Dimensions_Integration' ) ){

	class Bizline_Customizer_Dimensions_Integration extends Bizline_Customizer{
		...
		public static $class = 'Bizline_Customizer_Dimensions_Control';
		...
		public function start( $instance , $wp_customize ){
			...
			foreach( $instance::$fields[ self::$type ] as $field ){
				...
				if( !isset( $field[ 'dimension' ] ) ){
					$err = esc_html__( 'Missing key "dimension" passed for Dimension Control.', 'bizline' );
	...
	new Bizline_Customizer_Dimensions_Integration();
}
