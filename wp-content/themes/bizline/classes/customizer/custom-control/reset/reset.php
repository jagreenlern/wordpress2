...
* @since 1.0.0
*
* @package Bizline WordPress
*/

if ( class_exists( 'WP_Customize_Control' ) ) :

    class Bizline_Customizer_Reset extends WP_Customize_Control {
        ...
        public function scripts(){
            ...
            wp_localize_script( Bizline_Helper::with_prefix( 'customize-js' ), 'CUSTOMIZERRESET', array(
                'nonce'   => array(
                    'reset' => wp_create_nonce( 'customizer-reset' ),
                ),
                'confirm' => esc_html__( 'This action is not reversible! Are you sure to reset these settings?', 'bizline' )
            ));
        }
...
Bizline_Customizer::add_custom_control( array(
    'type'     => 'reset',
    'class'    => 'Bizline_Customizer_Reset',
    'sanitize' => false,
