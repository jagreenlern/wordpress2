<?php
/**
 * Customizer Control: bizline-toggle.
 *
 * @since 1.0.0
 *
 ...
 * @access public
 */
class Bizline_Toggle_Control extends WP_Customize_Control {
...
bizline_Customizer::add_custom_control( array(
    'type'     => 'toggle',
    'class'    => 'Bizline_Toggle_Control',
    'sanitize' => array( 'Bizline_Customizer', 'sanitize_checkbox' )
));