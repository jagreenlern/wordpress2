                    ...
                    <div class="product-tab-list clearfix">
                        ...
                        <ul class="tabs ecommerce-shop-products-tab clearfix">
                                <?php
                                    ...
                                    <li select_category_id = "<?php echo esc_attr( $products_id ); ?>" tab_slider_enable="<?php echo esc_attr( $product_tab_slider_enable ); ?>" tab_product_count = "<?php echo esc_attr( $products_tab_number_of_products ); ?>" class="ecommerce-shop-products-tabs-title tab-link  <?php if( $category_count == 1){ echo 'current'; }$category_count++; ?>"  data-tab="<?php echo esc_attr( $products_id ); ?>"><a href="#<?php echo esc_attr( $term->slug ); ?>"><?php echo esc_html( $term->name ); ?></a></li>
