    ...
    class Ecommerce_Lite_Repeater_Control extends WP_Customize_Control {
    	...
    	protected function render_content() {
    		...
    		<?php if ( isset( $this->choices['limit'] ) ) : ?>
    			<p class="limit"><?php printf( esc_html__( 'Limit: %s rows', 'ecommerce-lite' ), esc_html( $this->choices['limit'] ) ); ?></p>
    		<?php endif; ?>
    		...
    		<script type="text/html" class="customize-control-repeater-content">
    			...
    			<li class="repeater-row minimized" data-row="{{{ index }}}">
    				...
    				<div class="repeater-row-content">
    						...
    						<div class="repeater-field repeater-field-{{{ field.type }}}">
    							...
    							<# } else if ( field.type === 'image' || field.type === 'cropped_image' ) { #>
    								...
    								<figure class="kirki-image-attachment" data-placeholder="<?php esc_attr_e( 'No Image Selected', 'ecommerce-lite' ); ?>" >
    									...
    									<# } else { #>
    										<?php esc_html_e( 'No Image Selected', 'ecommerce-lite' ); ?>
    									<# } #>
    								</figure>
    
    								<div class="actions">
    									<button type="button" class="button remove-button<# if ( ! field.default ) { #> hidden<# } #>"><?php esc_html_e( 'Remove', 'ecommerce-lite' ); ?></button>
    									<button type="button" class="button upload-button" data-label=" <?php esc_attr_e( 'Add Image', 'ecommerce-lite' ); ?>" data-alt-label="<?php esc_attr_e( 'Change Image', 'ecommerce-lite' ); ?>" >
    										<# if ( field.default ) { #>
    											<?php esc_html_e( 'Change Image', 'ecommerce-lite' ); ?>
    										<# } else { #>
    											<?php esc_html_e( 'Add Image', 'ecommerce-lite' ); ?>
    										<# } #>
    									</button>
    									<# if ( field.default.id ) { #>
    							...
    							<# } else if ( field.type === 'upload' ) { #>
    								...
    								<figure class="kirki-file-attachment" data-placeholder="<?php esc_attr_e( 'No File Selected', 'ecommerce-lite' ); ?>" >
    									...
    									<# } else { #>
    										<?php esc_html_e( 'No File Selected', 'ecommerce-lite' ); ?>
    									<# } #>
    								</figure>
    								...
    								<div class="actions">
    									...
    									<button type="button" class="button upload-button" data-label="<?php esc_attr_e( 'Add File', 'ecommerce-lite' ); ?>" data-alt-label="<?php esc_attr_e( 'Change File', 'ecommerce-lite' ); ?>" >
    										<# if ( field.default ) { #>
    											<?php esc_html_e( 'Change File', 'ecommerce-lite' ); ?>
    										<# } else { #>
    											<?php esc_html_e( 'Add File', 'ecommerce-lite' ); ?>
    										<# } #>
    									</button>
    									<# if ( field.default.id ) { #>
    										<input type="hidden" class="hidden-field" value="{{{ field.default.id }}}" data-field="{{{ field.id }}}" >
    					...
    					<# }); #>
    					<button type="button" class="button-link repeater-row-remove"><?php esc_html_e( 'Remove', 'ecommerce-lite' ); ?></button>
    				</div>
    			</li>
    		</script>
    		<?php
