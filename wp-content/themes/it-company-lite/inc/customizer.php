...
function it_company_lite_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting('it_company_lite_loader_icon',array(
        'default' => 'Two Way',
        'sanitize_callback' => 'it_company_lite_sanitize_choices'
	));
	$wp_customize->add_control('it_company_lite_loader_icon',array(
        'type' => 'select',
        'label' => __('Pre-Loader Type','it-company-lite'),
        'section' => 'it_company_lite_left_right',
        'choices' => array(
            'Two Way' => __('Two Way','it-company-lite'),
            'Dots' => __('Dots','it-company-lite'),
            'Rotate' => __('Rotate','it-company-lite')
        ),
	) );
	...
	$wp_customize->add_setting( 'it_company_lite_metabox_hide_show',array(
      'default' => 1,
      'transport' => 'refresh',
      'sanitize_callback' => 'it_company_lite_switch_sanitization'
    ));  
    $wp_customize->add_control( new IT_Company_Lite_Toggle_Switch_Custom_Control( $wp_customize, 'it_company_lite_metabox_hide_show',array(
      'label' => esc_html__( 'Show / Hide Metabox','it-company-lite' ),
      'section' => 'it_company_lite_responsive_media'
    )));
	...
	$wp_customize->add_setting('it_company_lite_copyright_alingment',array(
        'default' => 'center',
        'sanitize_callback' => 'it_company_lite_sanitize_choices'
	));
	$wp_customize->add_control(new IT_Company_Lite_Image_Radio_Control($wp_customize, 'it_company_lite_copyright_alingment', array(
        'type' => 'select',
        'label' => __('Copyright Alignment','it-company-lite'),
        'section' => 'it_company_lite_footer',
        'settings' => 'it_company_lite_copyright_alingment',
        'choices' => array(
