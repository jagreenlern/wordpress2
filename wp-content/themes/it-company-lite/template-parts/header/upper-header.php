                	...
                	<div class="row">
                        	...
                        	<div class="col-lg-4 col-md-6">
                        		<?php if(get_theme_mod('it_company_lite_email_address') != ''){ ?>
                        			<i class="<?php echo esc_attr(get_theme_mod('it_company_lite_email_icon','fas fa-envelope-open')); ?>"></i><span><?php echo esc_html(get_theme_mod('it_company_lite_email_address',''));?></span>
                        		<?php }?>
                        	</div>
