...
$wp_customize->add_setting( 'kingston_theme_options[slider_opacity]', array(
	'default'          	=> kingston_theme_option('slider_opacity'),
	'sanitize_callback' => 'kingston_sanitize_number_range',
) );

$wp_customize->add_control( 'kingston_theme_options[slider_opacity]', array(
	'label'             => esc_html__( 'Overlay Opacity', 'kingston' ),
	'section'           => 'kingston_slider_section',
	'type'				=> 'range',
	'input_attrs'		=> array(
		'min'	=> 0,
