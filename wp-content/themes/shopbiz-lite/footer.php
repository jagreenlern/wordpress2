  ...
  <div class="ta-footer-copyright">
    <div class="container">
      <div class="row">
       ...
       $shopbiz_footer_copyright_setting = get_theme_mod('shopbiz_footer_copyright_setting','<p>'.__( '<a href="https://wordpress.org">Proudly powered by WordPress</a> | Theme: <a href="https://themeansar.com" rel="designer">Shopbiz Lite</a> by Themeansar', 'shopbiz-lite' ).'</p>');

      if( get_theme_mod( 'hide_copyright' ) !='false') { echo wp_kses_post($shopbiz_footer_copyright_setting); } ?>
		</div>
