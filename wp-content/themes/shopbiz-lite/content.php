	...
	<div class="ta-blog-post-box"> 
		...
		<article class="small">
			...
			<div class="ta-blog-category"> 
				...
				<a href="<?php echo esc_url(get_author_posts_url( get_the_author_meta( 'ID' ) ));?>"><i class="fa fa-user"></i> <?php _e('by','shopbiz-lite'); echo " "; the_author(); ?>
				</a> 
			</div>
			<?php the_content(); ?>
			<?php wp_link_pages( array( 'before' => '<div class="link">' . __('Pages:', 'shopbiz-lite' ), 'after' => '</div>' ) ); ?>
		</article>
	</div>
</div>