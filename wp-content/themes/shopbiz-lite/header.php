...
<body <?php body_class(); ?> >
<?php wp_body_open(); ?>
<a class="skip-link screen-reader-text" href="#content"><?php _e( 'Skip to content', 'shopbiz-lite' ); ?></a>
<div class="wrapper">
<header>
  <!--==================== TOP BAR ====================-->
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 col-xs-12 col-sm-6">
          <ul class="info-left">
            ...
            ?>
            <?php echo $shopbiz_head_info_one; ?>
            <?php echo $shopbiz_head_info_two; ?>
          </ul>
        </div>
      ...
      <div class="col-md-6 col-xs-12">
        <?php if ( has_nav_menu( 'social' ) ) : ?>
          <nav class="ta-social-navigation" role="navigation" aria-label="<?php esc_attr_e( 'Social Links Menu', 'shopbiz-lite' ); ?>">
            <?php
              wp_nav_menu( array(
                ...
                'link_after'     => '</span>' . shopbiz_include_svg_icons( array( 'icon' => 'chain' ) ),
              ) );
            ?>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <?php wp_nav_menu( array(  
				'theme_location' => 'primary', 'container'  => '', 'menu_class' => 'nav navbar-nav navbar-right','fallback_cb' => 'shopbiz_fallback_page_menu','walker' => new shopbiz_nav_walker()
				 ) ); ?>
        </div>
