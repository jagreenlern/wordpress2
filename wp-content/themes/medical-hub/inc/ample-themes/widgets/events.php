<?php
if (!class_exists('Medical_Hub_Events_Post_Widget')) {
    class Medical_Hub_Events_Post_Widget extends WP_Widget
    {
        ...
        private function defaults()
        {
            ...
            $defaults = array(
                'cat_id' => 0,
                'title' => esc_html__('Events ', 'medical-hub'),
                'sub-title' => '',
        ...
        {
            parent::__construct(
                'medical-hub-events-post-widget',
                esc_html__('AT : Events  Widget', 'medical-hub'),
                array('description' => esc_html__('Business Events Post Section', 'medical-hub'))
            );
        }
        ...
        public function form($instance)
        {
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('cat_id')); ?>">
                    <?php esc_html_e('Select Category For events', 'medical-hub'); ?>
                </label><br/>
                <?php
                                                ...
                                                <div class="blog-details">
                                                    <header class="entry-header">
                                                        ...
                                                        <div class="entry-content">
                                                            ...
                                                            <a href="<?php the_permalink();?>" class="continue-link"><?php esc_html_e('Continue Reading', 'medical-hub'); ?></a>
...
add_action('widgets_init', 'medical_hub_events_widget');
function medical_hub_events_widget()
{
    register_widget('Medical_Hub_Events_Post_Widget');
