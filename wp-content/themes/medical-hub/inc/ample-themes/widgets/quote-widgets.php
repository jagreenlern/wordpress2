<?php
if (!class_exists('Medical_Hub_Quote_Widget')) {
    class Medical_Hub_Quote_Widget extends WP_Widget
    {
        private function defaults()
        {
            $defaults = array(
                'title' => '',
                'button-text1' => esc_html__('button1', 'medical-hub'),
                'button-text-link1' => '#',
                'button-text2' => esc_html__('button2', 'medical-hub'),
                'button-text-link2' => '#',
                'features_background' => '',
            );
            return $defaults;
        ...
        {
            parent::__construct(
                'medical-hub-quote-widget',
                esc_html__('AT : Quote Widget', 'medical-hub'),
                array('description' => esc_html__('Business Quote Section', 'medical-hub'))
            );
        }
        ...
        public function form($instance)
        {
            ...
            <p>
                <label
                        for="<?php echo esc_attr($this->get_field_id('button-text1')); ?>"><?php esc_html_e('Button Text1', 'medical-hub'); ?></label><br/>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('button-text-link1')); ?>">
                    <?php esc_html_e('Button Link1', 'medical-hub'); ?>
                </label><br/>
            ...
            <p>
                <label
                        for="<?php echo esc_attr($this->get_field_id('button-text2')); ?>"><?php esc_html_e('Button Text2', 'medical-hub'); ?></label><br/>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('button-text-link2')); ?>">
                    <?php esc_html_e('Button Link2', 'medical-hub'); ?>
                </label><br/>
        ...
        public function widget($args, $instance)
        {
            ...
            if (!empty($instance)) {
                ...
                ?>
                <section id="medical-hub-theme-meetbutton" class="widget widget-medical-hub-theme-meetbutton"
...
add_action('widgets_init', 'medical_hub_quote_widget');
function medical_hub_quote_widget()
{
    register_widget('Medical_Hub_Quote_Widget');
