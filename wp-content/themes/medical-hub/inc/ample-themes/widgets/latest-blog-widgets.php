<?php
if (!class_exists('Medical_Hub_Recent_Post_Widget')) {
    class Medical_Hub_Recent_Post_Widget extends WP_Widget
    {
        ...
        private function defaults()
        {
            ...
            $defaults = array(
                'cat_id' => 0,
                'title' => esc_html__('Latest Blogs', 'medical-hub'),
                'sub-title' => '',
        ...
        {
            parent::__construct(
                'medical-hub-recent-post-widget',
                esc_html__(' AT : Latest Blog Widget', 'medical-hub'),
                array('description' => esc_html__('Business Latest Blog Section', 'medical-hub'))
            );
        }
        ...
        public function form($instance)
        {
            ...
            <p>
                ...
                $business_con_dropown_cat = array(
                    'show_option_none' => esc_html__('From Recent Posts', 'medical-hub'),
                    'orderby' => 'name',
                    'order' => 'asc',
                    'show_count' => 1,
                    'hide_empty' => 1,
        ...
        public function widget($args, $instance)
        {
            ...
            if (!empty($instance)) {
                ...
                ?>
                <section id="medical-hub-theme-blog" class="">
                    <div class="container">
                                                ...
                                                <div class="blog-details">
                                                    <header class="entry-header">
                                                        ...
                                                        <a href="<?php comments_link(); ?>" rel="">
                                                            ...
                                                            <time class="entry-date published" datetime=""><?php  esc_html_e('Leave a comment','medical-hub')?></time>
                                                        </a>
                                                        </span>
                                                        </div>
...
add_action('widgets_init', 'medical_hub_recent_post_widget');
function medical_hub_recent_post_widget()
{
    register_widget('Medical_Hub_Recent_Post_Widget');
