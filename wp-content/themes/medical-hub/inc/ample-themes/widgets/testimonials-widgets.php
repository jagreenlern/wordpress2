<?php
if (!class_exists('Medical_Hub_Testimonials_Widget')) {
    class Medical_Hub_Testimonials_Widget extends WP_Widget
    {
        ...
        private function defaults()
        {
            ...
            $defaults = array(
                'title' => esc_html__('Our Testimonials', 'medical-hub'),
                'sub-title' => '',
                'resources' => '',
                'features_background' => '',
        ...
        public function __construct()
        {
            parent::__construct(
                ...
                esc_html__('AT : Testimonials Widget', 'medical-hub'),
                array('description' => esc_html__('Business Testimonials Section', 'medical-hub'))
            );
        }
        public function form( $instance )
        {
            ...
            <!--repeater-->
            <label><?php _e( 'Select Pages', 'medical-hub' ); ?>:</label>
            <br/>
            <small><?php _e( 'Add Page and Remove. Please do not forget to add Icon on selected pages.', 'medical-hub' ); ?></small>
                ...
                $args = array(
                    ...
                    'show_option_none'  => __( 'Select Page', 'medical-hub'),
            ...
            <a class="at-ample-add button" data-id="medical-hub_resource_widget" id="<?php echo  esc_attr( $repeater_id); ?>"><?php _e('Add New Section', 'medical-hub'); ?></a>
            ...
            <p>
                ...
                <span class="img-preview-wrap" <?php  if ( empty( $features_background ) ){ ?> style="display:none;" <?php  } ?>>
                    <img class="widefat" src="<?php echo esc_url( $features_background ); ?>" alt="<?php esc_attr_e( 'Image preview', 'medical-hub' ); ?>"  />
                ...
                <input type="button" id="custom_media_button"  value="<?php esc_attr_e( 'Upload Image', 'medical-hub' ); ?>" class="button media-image-upload" data-title="<?php esc_attr_e( 'Select Background Image','medical-hub'); ?>" data-button="<?php esc_attr_e( 'Select Background Image','medical-hub'); ?>"/>
                <input type="button" id="remove_media_button" value="<?php esc_attr_e( 'Remove Image', 'medical-hub' ); ?>" class="button media-image-remove" />
            </p>
            <?php
        }
...
add_action('widgets_init', 'medical_hub_testimonials_widget');
function medical_hub_testimonials_widget()
{
    register_widget('Medical_Hub_Testimonials_Widget');
