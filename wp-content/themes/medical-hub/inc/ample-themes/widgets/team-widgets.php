<?php
if (!class_exists('Medical_Hub_Team_Widget')) {
    class Medical_Hub_Team_Widget extends WP_Widget
    {
        ...
        private function defaults()
        {
            ...
            $defaults = array(
                'title' => esc_html__('Our Team', 'medical-hub'),
                'sub-title' => '',
                'resources' => ''
        ...
        public function __construct()
        {
            parent::__construct(
                ...
                esc_html__('AT : Team Widget', 'medical-hub'),
                array('description' => esc_html__('Business Team Section', 'medical-hub'))
            );
        }
        public function form( $instance )
        {
            ...
            <br/>
            <small><?php _e( 'Add Page and Remove. Please do not forget to add image with team and excerpt for position for employ on selected pages.', 'medical-hub' ); ?></small>
...
add_action('widgets_init', 'medical_hub_team_widget');
function medical_hub_team_widget()
{
    register_widget('Medical_Hub_Team_Widget');
