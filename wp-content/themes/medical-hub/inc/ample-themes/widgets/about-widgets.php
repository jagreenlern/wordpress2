<?php
if (!class_exists('Medical_Hub_Details_Widget')) {
    class Medical_Hub_Details_Widget extends WP_Widget
    {
        ...
        {
            parent::__construct(
                'Medical_Details_widget',
                esc_html__('AT :  About us Widget', 'medical-hub'),
                array('description' => esc_html__('Medical Abouts Section', 'medical-hub'))
            );
        }
        public function form( $instance )
        {
            ...
            <br/>
            <small><?php _e( 'Add Page and Remove. Please do not forget to add image on selected pages.', 'medical-hub' ); ?></small>
                ...
                <div class="container">
                    <div class="row about">
                                <?php if (isset($resources) && !empty($resources['main'])) { ?>
                                    ...
                                    $icon = get_post_meta(get_the_ID(), 'medical_hub_icon', true);
                                    $idvalue[] = get_the_ID();
                                            ...
                                            <?php }
                                                ...
                                                <div class="col-xs-12 col-sm-4 wow" data-wow-duration="2s">
                                                    <div id="text-1" class="widget-area widget-footer-top about">
                                                        <?php
                                                        ...
                                                        if(!empty($icon)){
                                                            ...
                                                            <div class="service-icon color">
                                                                <i class="fa <?php echo esc_attr($icon); ?>"
                                                                   aria-hidden="true"></i>
                                                                <div></div>
                                                            </div>
                                                            <?php
                                                        ...
                                                        <a href="<?php the_permalink();?>" class="continue-link"><?php esc_html_e('Learn More', 'medical-hub'); ?></a>
                                                            </div>
                                                    </div>
                                                </div>
                                                     </div>
...
add_action('widgets_init', 'medical_hub_details_widget');
function medical_hub_details_widget()
{
    register_widget('Medical_Hub_Details_Widget');
