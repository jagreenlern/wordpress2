 ...
 * Time: 8:43 AM
 */
if (!class_exists('Medical_Hub_notice_Widget')) {
    class Medical_Hub_notice_Widget extends WP_Widget
    {
        ...
        private function defaults()
        {
            ...
            $defaults = array(
                'cat_id' => 0,
                'title' => esc_html__('Noticed', 'medical-hub'),
                'sub-title' =>'',
                'image'=>'',
                'post_number' =>3,
            );
        ...
        {
            parent::__construct(
                'medical-hub-notice-widget',
                esc_html__('AT : Notice Widgets', 'medical-hub'),
                array('description' => esc_html__('Business Noticed Section', 'medical-hub'))
            );
        }
        ...
        public function form($instance)
        {
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('cat_id')); ?>">
                    <?php esc_html_e('Select Category', 'medical-hub'); ?>
                </label><br/>
                <?php
                $business_dropown_cat = array(
                    'show_option_none' => esc_html__('Select Category', 'medical-hub'),
                    'orderby' => 'name',
                    'order' => 'asc',
                    'show_count' => 1,
                    'hide_empty' => 1,
            ...
            <hr>
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('post_number')); ?>"><strong><?php esc_html_e('Number of Posts:', 'medical-hub'); ?></strong></label>
        ...
        public function widget($args, $instance)
        {
            if (!empty($instance)) {
                ...
                ?>
                <section id="medical-hub-theme-feature" class="widget widget-medical-hub-theme-feature">
                <div class="container">
                  <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 wow fadeInRightBig"  data-wow-duration="2s">
                      <div class="feature-image">
                        <img src="<?php echo  esc_url($image);?>" title="" class="img-responsive">
                      </div>
                    </div>
                  </div>
                </div>
...
add_action('widgets_init', 'medical_hub_notice_widget');
function medical_hub_notice_widget()
{
    register_widget('Medical_Hub_notice_Widget');
