<?php
if (!class_exists('Medical_Hub_Resource_Widget')) {
    class Medical_Hub_Resource_Widget extends WP_Widget
    {
        ...
        private function defaults()
        {
            ...
            $defaults = array(
                'title' => esc_html__('Our Services', 'medical-hub'),
                'sub-title' => '',
                'resources' => ''
        ...
        public function __construct()
        {
            parent::__construct(
                ...
                esc_html__('AT : Services Widget', 'medical-hub'),
                array('description' => esc_html__('Business Services Section', 'medical-hub'))
            );
        }
        ...
        public function widget($args, $instance)
        {
            ...
            if (!empty($instance)) {
                ...
                ?>
                <section id="medical-hub-theme-service" class="widget widget-medical-hub-theme-service">
                    <div class="container">
...
add_action('widgets_init', 'medical_hub_resource_widget');
function medical_hub_resource_widget()
{
    register_widget('Medical_Hub_resource_Widget');
