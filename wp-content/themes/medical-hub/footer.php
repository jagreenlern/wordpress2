 ...
 */
$copyright = medical_hub_get_option('medical_hub_copyright');
		...
		<div class="container">
			<div class="copyright">
				...
				<p><?php echo wp_kses_post($copyright); ?> |
					<a href="<?php echo esc_url( __( 'https://www.amplethemes.com/', 'medical-hub' ) ); ?>"
                    ><?php
						/* translators: %s: CMS name, i.e. WordPress. */
						printf( esc_html__( ' Design & develop by AmpleThemes %s', 'medical-hub' ), '' );
						?></a>	</p>
