<?php
get_header();
$medical_hub_hide_front_page_content = medical_hub_get_option('medical_hub_front_page_hide_option');
if (!is_home()) {
    $medical_hub_slider_section_option = medical_hub_get_option('medical_hub_homepage_slider_option');
    if ($medical_hub_slider_section_option != 'hide') {
        ...
        <div class="features-slider">
            <div id="owl-demo1" class="owl-carousel owl-theme">
                ...
                <?php
                $all_slider = wp_kses_post(get_theme_mod('medical_hub_banner_all_sliders'));
                if (!empty($all_slider)) {
                                            ...
                                            <div class="container">
                                                ...
                                                <div class="know-more">
                                                    <a href="<?php the_permalink() ?>"
                                                       class="read-more-background know"><?php esc_html_e('Know More', 'medical-hub'); ?></a>
...
if ('posts' == get_option('show_on_front')) {
    ...
    if (1 != $medical_hub_hide_front_page_content) {
