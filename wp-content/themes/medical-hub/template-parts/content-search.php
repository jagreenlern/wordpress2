 ...
 * @package Bussiness_agency
 */
$description_from = medical_hub_get_option('medical_hub_blog_excerpt_option');
$description_length = medical_hub_get_option('medical_hub_description_length_option');
...
<article id="post-<?php the_ID(); ?>"class="post type-post status-publish has-post-thumbnail hentry" <?php post_class(); ?>>
    ...
    <div class="entry-content">
        ...
        ?>
        <a href="<?php the_permalink(); ?>"
           class="article-readmore"><?php esc_html_e('Continue Reading', 'medical-hub'); ?><span
                class="arrow-continue"><?php echo esc_html__('→','medical-hub');?></span></a>
    </div>
