<?php // Register and load the widget
	...
	<!-- Google-Plus Link -->
	<h4 for="<?php echo esc_attr($this->get_field_id( 'google_plus_link' )); ?>"><?php esc_html_e( 'Google-Plus URL','honeywaves' ); ?></h4>
	...
	<label for="<?php echo esc_attr($this->get_field_id( 'google_plus_target' )); ?>"><?php esc_html_e( 'Open link in new tab','honeywaves' ); ?></label>
	...
	$instance = array();
		...
		$instance['google_plus_target'] = ( ! empty( $new_instance['google_plus_target'] ) ) ? honeywaves_sanitize_checkbox( $new_instance['google_plus_target'] ) : '';
