...
$wp_customize->add_panel( 'header_top_panel', array(
    'title'          => __( 'Header Top', 'travel-ace' ),
    'priority'       => 20,
...
$wp_customize->add_section(
    ...
    array(
        'title'    => __( 'Contact Info', 'travel-ace' ),
...
$wp_customize->add_control(
    'theme_options[show_header_contact_info]',
    array(
        'label'       => __( 'Show Contact Info', 'travel-ace' ),
...
$wp_customize->add_control(
    ...
    array(
        'label'           => __( 'Location', 'travel-ace' ),
        'description'     => __( 'Enter Location.', 'travel-ace' ),
        'section'         => 'header_contact_info_section',
        'active_callback' => 'travel_ace_contact_info_ac',
    )
);

/** Phone */
$wp_customize->add_setting( 'theme_options[header_phone]', array(
    'sanitize_callback' => 'travel_ace_sanitize_phone_number',
) );

$wp_customize->add_control(
    'theme_options[header_phone]',
    array(
        'label'           => __( 'Phone', 'travel-ace' ),
        'description'     => __( 'Enter phone number.', 'travel-ace' ),
        'section'         => 'header_contact_info_section',
        'active_callback' => 'travel_ace_contact_info_ac',
    )
);
...
$wp_customize->add_section(
    ...
    array(
        'title'    => __( 'Social Links', 'travel-ace' ),
        'panel'    => 'header_top_panel',
        'priority' => 20,
    )
);
...
$wp_customize->add_control(
    'theme_options[show_header_social_links]',
    array(
        'label'       => __( 'Show Social Links', 'travel-ace' ),
...
$wp_customize->add_control(
    'theme_options[social_link_1]',
    array(
        'label'           => __( 'Social Link 1', 'travel-ace' ),
        'description'     => __( 'Enter valid url.', 'travel-ace' ),
        'section'         => 'header_social_links_section',
        'type'            => 'url',
        'active_callback' => 'travel_ace_social_links_active',
    )
);
...
$wp_customize->add_control(
    'theme_options[social_link_2]',
    array(
        'label'           => __( 'Social Link 2', 'travel-ace' ),
        'description'     => __( 'Enter valid url.', 'travel-ace' ),
        'section'         => 'header_social_links_section',
        'type'            => 'url',
        'active_callback' => 'travel_ace_social_links_active',
...
$wp_customize->add_control(
    'theme_options[social_link_3]',
    array(
        'label'           => __( 'Social Link 3', 'travel-ace' ),
        'description'     => __( 'Enter valid url.', 'travel-ace' ),
        'section'         => 'header_social_links_section',
        'type'            => 'url',
        'active_callback' => 'travel_ace_social_links_active',
