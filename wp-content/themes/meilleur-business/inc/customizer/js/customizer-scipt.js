...
*/
 jQuery(document).ready(function($) {
    $('#meilleur-business-img-container li label img').click(function(){    	
        $('#meilleur-business-img-container li').each(function(){
            $(this).find('img').removeClass ('meilleur-business-radio-img-selected') ;
        });
        $(this).addClass ('meilleur-business-radio-img-selected') ;
    });                    
});
