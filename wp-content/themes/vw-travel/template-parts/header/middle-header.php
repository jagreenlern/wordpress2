...
<div id="topbar">
  <div class="header-menu <?php if( get_theme_mod( 'vw_travel_sticky_header', false) != '' || get_theme_mod( 'vw_travel_stickyheader_hide_show', false) != '') { ?> header-sticky"<?php } else { ?>close-sticky <?php } ?>">
