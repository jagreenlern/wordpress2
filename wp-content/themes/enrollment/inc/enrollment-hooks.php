...
if ( ! function_exists( 'enrollment_body_open_hook' ) ) :
	...
	* @since 5.2.0   
	*/
    function enrollment_body_open_hook() {
        wp_body_open();
    }
...
/**
 * managed function for body hooks
 */
add_action('body_open_hook','enrollment_body_open_hook',5);