...
<body <?php body_class(); ?>>
    ...
    <?php
         ...
         * hook - body_open_hook
         *
         * @hooked - enrollment_body_open_hook - 5
         */
            do_action('body_open_hook');
        }

        do_action( 'enrollment_before_main' );
    ?>
<div id="page" class="site">
<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'enrollment' ); ?></a>
	<?php

		do_action( 'enrollment_before_header' );
