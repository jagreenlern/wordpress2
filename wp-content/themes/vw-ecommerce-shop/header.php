            ...
            <div class="row">
              ...
              <div class="top-contact col-lg-3 col-md-3">
                <?php if( get_theme_mod( 'vw_ecommerce_shop_contact','' ) != '') { ?>
                  <span class="call"><i class="<?php echo esc_attr(get_theme_mod('vw_ecommerce_shop_phone_no_icon','fa fa-phone')); ?>"></i><?php echo esc_html( get_theme_mod('vw_ecommerce_shop_contact','') ); ?></span>
                 <?php } ?>
              </div>
            </div>
          </div>
