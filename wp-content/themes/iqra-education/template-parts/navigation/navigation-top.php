		...
		<div class="searchform-inner">
      	...
      	<?php if( get_theme_mod( 'iqra_education_login_url') != '') { ?>
			<div class="account col-lg-2 col-md-3 py-3 px-0 text-center">
            	<a href="<?php echo esc_html(get_theme_mod('iqra_education_login_url',''));?>" class="py-3"><i class="fas fa-user pr-2"></i><?php esc_html_e('Login / Register','iqra-education'); ?><span class="screen-reader-text"><?php esc_html_e( 'Login / Register','iqra-education' );?></span></a>
			</div>
        <?php } ?>
	</div>
</div>