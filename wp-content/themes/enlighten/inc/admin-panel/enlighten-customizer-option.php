...
//Add Section 
$wp_customize->add_section(
    'enlighten_archive_section',
    array(
        'title' => esc_html__('Archive Setting','enlighten'),
        'priority' => 5,
        'capability' => 'edit_theme_options',
        'theme_support' => ''
    )
...
$wp_customize->add_setting(
    'enlighten_archive_meta_data_disable',
    array(
        'default' => '',
        'sanitize_callback' => 'enlighten_sanitize_checkbox'
    )
...
$wp_customize->add_control(
    'enlighten_archive_meta_data_disable',
    array(
        'label' => esc_html__('Disable Meta Data','enlighten'),
        'section' => 'enlighten_archive_section',
        'type' => 'checkbox',
        'priority' => 1
    )
);
...
$wp_customize->add_control(
    'enlighten_archive_img_disable',
    array(
        'label' => esc_html__('Disable Featured Image','enlighten'),
        'section' => 'enlighten_archive_section',
        'type' => 'checkbox',
        'priority' => 1
    )
...
$wp_customize->add_setting(
    'enlighten_archive_excerpt_lenght',
    array(
        'default' => '150',
        'sanitize_callback' => 'absint'
    )
...
$wp_customize->add_control(
    'enlighten_archive_excerpt_lenght',
    array(
        'label' => esc_html__('Excerpt length','enlighten'),
        'section' => 'enlighten_archive_section',
        'type' => 'number',
        'priority' => 2
    )
