...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'enlighten' ); ?></a>
        ...
        <div class="ak-container">
            ...
            <?php if($enlighten_header_text){ ?>
                <div class="header_text">
                    <span class="text_wrap"><?php echo esc_html($enlighten_header_text); ?></span>
                </div>
            <?php } ?>
                          ...
                          if($enlighten_number){ ?>
                            <div class="phone_header wow fadeIn">
                                ...
                                <div class="title_phone">
                                    ...
                                    <span class="phone"><?php echo esc_html($enlighten_number); ?></span>
                                </div>
                            </div>
                          <?php }
                          ...
                          if($enlighten_email){ ?>
                            <div class="email_header wow fadeIn">
                                ...
                                <div class="title_email_wrap">
                                    ...
                                    <span class="email_address"><?php echo esc_html($enlighten_email); ?></span>
                                </div>
                            </div>
                            <?php }
                          ...
                          if($enlighten_location){ ?>
                            <div class="location_header wow fadeIn">
                                ...
                                <div class="title_location_wrap">
                                    ...
                                    <span class="location"><?php echo esc_html($enlighten_location); ?></span>
                                </div>
                            </div>
                          <?php } ?>
                      </div>
