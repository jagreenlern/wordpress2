        ...
        if($enlighten_cta_post){
            ...
            <?php if($enlighten_cta_posts->have_posts()){
                ...
                <?php if($enlighten_cta_buttom_link){ ?>
                        <span class="button_cta"><a target="_blank" class="cta_button" href="<?php echo esc_url($enlighten_cta_buttom_link); ?>"><?php echo esc_html($enlighten_cta_button_text); ?></a></span>
                <?php }
            }
        } ?>
    </div>
