...
Burst
License: CC0 1.0 Universal (CC0 1.0)
Source: https://stocksnap.io/photo/man-working-UN5XQREKKP
    
== Changelog ==
== 1.3.5 ==
** Fixed minor js issues
** Added Featured Image Disable Option for Archive Page
...
= 1.3.2 =
** Fixed Slider Link Not Opening issues
...
= 1.2.7 =
** Fixed Dynamic Color issues in widget

= 1.2.6 =
** Fixed Dynamic Color issues in mobile menu
...
= 1.2.4 =
** Fixed Portfolio Slider Pager Issue

= 1.2.3 =
** Security Issues Fixed

= 1.2.2 =
** Fixed portfolio section issue.
** Fixed Service section issues.
** Fixed client section issues.
** Add Woocommerce Compatible features.
...
= 1.2.0 =
** Fixed Archive Page title issue.
...
= 1.1.8 =
** Made the customizer field translation ready

= 1.1.7 =
** Added Unlimited Template Color Option
** Fixed Minor Design Issues
