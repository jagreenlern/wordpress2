...
if ( ! function_exists( 'bizblack_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function bizblack_posted_on() {
...
if ( ! function_exists( 'bizblack_posted_by' ) ) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function bizblack_posted_by() {
		$byline = sprintf(
			/* translators: %s: post author. */
			esc_html( '%s', 'post author', 'bizblack' ),
...
if ( ! function_exists( 'bizblack_post_comments' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time and author.
	 */
	function bizblack_post_comments() {
...
if ( ! function_exists( 'bizblack_entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function bizblack_entry_footer() {
...
if ( ! function_exists( 'bizblack_post_thumbnail' ) ) :
	/**
	 ...
	 */
	function bizblack_post_thumbnail() {
...
if( ! function_exists( 'bizblack_fontawesome_social_icons_lists' ) ) :
	/**
     * Font Awesome
     *
	...
	function bizblack_fontawesome_social_icons_lists() {
