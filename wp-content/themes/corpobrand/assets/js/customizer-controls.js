...
jQuery( document ).ready(function($) {
    ...
    $(".corpobrand-chosen-select").chosen({
        width: "100%"
    });
    ...
    $( document ).on( 'click', '.customize_multi_add_field', corpobrand_customize_multi_add_field )
        .on( 'change', '.customize_multi_single_field', corpobrand_customize_multi_single_field )
        .on( 'click', '.customize_multi_remove_field', corpobrand_customize_multi_remove_field )
    ...
    function corpobrand_customize_multi_add_field(e) {
        ...
        e.preventDefault();
            ...
            corpobrand_customize_multi_write( $control );
    }

    function corpobrand_customize_multi_single_field() {
        var $control = $( this ).parents( '.customize_multi_input' );
        corpobrand_customize_multi_write( $control );
    }

    function corpobrand_customize_multi_remove_field(e) {
        e.preventDefault();
        var $this = $( this );
        var $control = $this.parents( '.customize_multi_input' );
        $this.parent().remove();
    ...
    function corpobrand_customize_multi_write( $element) {
