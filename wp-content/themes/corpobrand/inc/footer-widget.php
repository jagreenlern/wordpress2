...
class Corpobrand_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'corpobrand';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'corpobrand' ), $i ),
...
// Initialize.
$corpobrand_footer_widgets = new Corpobrand_Footer_Widgets();
