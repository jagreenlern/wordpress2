        ...
        <div class="row">
          <div class="col-lg-4 col-md-4">
            <?php 
              ...
              if($it_company_catData){
                ...
                <div class="right-part mb-4 text-md-left text-center">
                  <div class="row m-0"> 
                    <div class="col-lg-3 col-md-3">
                      <div class="abt-img-box text-center"><?php if(has_post_thumbnail()) { ?><?php the_post_thumbnail(); ?><?php } ?></div>
                    </div>
                    <div class="col-lg-9 col-md-9 p-0">
                      <h3 class="pt-md-0 text-md-left text-center"><?php the_title(); ?></h3>     
                      <p class="mb-md-3 mb-1 text-md-left text-center"><?php $excerpt = get_the_excerpt(); echo esc_html( it_company_string_limit_words( $excerpt, esc_attr(get_theme_mod('it_company_about_excerpt_number','10')))); ?></p>
          ...
          <div class="col-lg-4 col-md-4">
            <?php 
              ...
              $page_query = new WP_Query(array( 'category_name' => esc_html($it_company_catData,'it-company')));?>
              <?php while( $page_query->have_posts() ) : $page_query->the_post(); ?>
              <div class="left-part mb-4 text-md-left text-center">
                <div class="row m-0"> 
                  <div class="col-lg-3 col-md-3">
                    <div class="abt-img-box text-center"><?php if(has_post_thumbnail()) { ?><?php the_post_thumbnail(); ?><?php } ?></div>
                  </div>
