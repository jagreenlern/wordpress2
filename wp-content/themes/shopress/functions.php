 ...
 */
	...
	require( $shopress_theme_path . '/customize/class-alpha-color-control/class-alpha-color-control.php');
...
function shopress_excerpt_more_button( $more ) {
	return '<br><a class="btn btn-theme post-btn" href="' . get_permalink() . '">'.__('Read More','shopress').'</a>';
}
add_filter( 'excerpt_more', 'shopress_excerpt_more_button', 20 );	
