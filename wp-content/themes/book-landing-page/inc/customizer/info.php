...
if ( ! function_exists( 'book_landing_page_customizer_theme_info' ) ) :
	...
	function book_landing_page_customizer_theme_info( $wp_customize ) {
		...
		$theme_info .= sprintf( '%1$s<a href="%2$s" target="_blank">%3$s</a>', esc_html__( 'Demo Link : ', 'book-landing-page' ), esc_url( __( 'https://rarathemes.com/previews/?theme=book-landing-page', 'book-landing-page' ) ), esc_html__( 'Click here.', 'book-landing-page' ) );
