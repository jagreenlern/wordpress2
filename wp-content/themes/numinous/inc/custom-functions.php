...
function numinous_scripts() {
    ...
    wp_enqueue_script( 'numinous-modal-accessibility', get_template_directory_uri() . '/js' . $build . '/modal-accessibility' . $suffix . '.js', array( 'jquery' ), NUMINOUS_THEME_VERSION, true );
