...
$elixar_enabled   = intval( get_theme_mod( 'elixar_blog_enable', 1 ) );
...
if ( $elixar_enabled == 1 ) : ?>
<div id="<?php if ( $elixar_id != '' ) { echo esc_attr( $elixar_id ); } ?>" class="content-section sp-sm section-wrapper section-dark section-blog elixar_blog">
	<div class="container">
