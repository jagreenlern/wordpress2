...
$elixar_enabled  = intval( get_theme_mod( 'elixar_services_enable', 1 ) );
...
$elixar_service_layout = intval( get_theme_mod( 'elixar_service_layout', 4 ) );
$elixar_desc = get_theme_mod( 'elixar_services_desc' );
if ( $elixar_enabled == 1 ) : ?>
<!-- SECTION -->
<div id="<?php if ($elixar_id != '') { echo esc_attr( $elixar_id ); } ?>" class="content-section section-wrapper sp-sm section-dark section-services elixar_services">
	<div class="container">
