...
function elixar_sanitize_text( $string ) {
    return wp_kses_post( balanceTags( $string ) );
}

function elixar_sanitize_html_input( $string ) {
...
function elixar_sanitize_json_string($value, $control){
    $choices = $control->manager->get_control( $control->id )->choices;
