...
function coachpress_lite_get_banner_sub_title(){
    return esc_html( get_theme_mod( 'banner_subtitle', __( 'To empower women to make a positive impact on the world with fiery passion, unbridled self-belief, and head-turning style.', 'coachpress-lite' ) ) );
}
endif;
...
function coachpress_lite_get_blog_content(){
    return wp_kses_post( wpautop( get_theme_mod( 'blog_section_desc', __( 'Show your latest blog posts here. You can modify this section from Appearance > Customize > Front Page Settings > Blog Section.', 'coachpress-lite' ) ) ) );
}
endif;
