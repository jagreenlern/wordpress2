	...
	public function block_area_description() {
		return wp_kses(
			sprintf(
				...
				__( 'This is the content of the block area. You can create or edit the block area in the <a href="%s" target="_blank">Reusable Blocks Manager (opens in a new window)</a>.<br>The selected block content will appear on the block area.', 'oceanly' ),
