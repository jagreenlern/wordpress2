						...
						<div class="oceanly-panel-content">
							...
							<div class="oceanly-check-list-wrap">
								...
								<ul class="oceanly-check-list">
									...
									<li><?php esc_html_e( 'Custom Google Fonts', 'oceanly' ); ?></li>
								</ul>
								<ul class="oceanly-check-list">
	...
	if ( is_admin() && isset( $_GET['activated'] ) && 'themes.php' === $pagenow ) { // phpcs:ignore
		...
		<div class="updated notice notice-success is-dismissible">
			...
			<p>
				...
				&nbsp;
				<a target="_blank" class="button" href="<?php echo esc_url( Oceanly\Helpers::get_upsell_detail_url() ); ?>">
					<?php esc_html_e( 'Check Premium Version', 'oceanly' ); ?>
				</a>
			</p>
		</div>
		<?php
