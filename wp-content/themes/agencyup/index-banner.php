...
<div class="bs-breadcrumb-section" style='background: url("<?php echo esc_url( $background_image ); ?>" ) repeat 
<?php echo esc_attr($breadcrumb_img_type_display); ?> center 0 #143745;'>
  <div class="overlay">
    <div class="container">
      <div class="row">
