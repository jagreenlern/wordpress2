    ...
    <script>
      ...
      $('.day').click(function() {
          if ($(this).hasClass('future')) {
              ...
              $('#modal .wrapper .content .box').php("<h2>Naughty, naughty.</h2> <p>You can't look early! Check back on that day to see what I've left for you.</p>");
          }
          if ($(this).hasClass('past')) {
              var content = $(this).children('.surprise').php();
              $('#modal').addClass('active');
              $('#modal .wrapper .content .box').php('');
              $('#modal .wrapper .content .box').php(content);
          }
      })
