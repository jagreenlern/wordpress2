...
if($action == 'ajax'){
	...
	$query = mysqli_query($con,"SELECT * FROM tblprod where tblprod.prod_name LIKE '%$query%' order by tblprod.prod_name LIMIT $offset,$per_page");
			...
			<table class="table table-striped table-hover">
				...
				<tbody>	
						...
						<tr class="<?php echo $text_class;?>">
							...
							<td>
								<!-- abre modales si ponemos este href y no hace falta mas para abrirlo en los scricts-->
