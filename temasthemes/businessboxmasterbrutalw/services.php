        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item active" ><a class="nav-link smooth-scroll" href="services.php">Services</a></li> 
                <li class="nav-item dropdown" >
                  ...
                  <div class="dropdown-menu dropdown-cust" aria-labelledby="navbarDropdownMenuLink"> 
                    ...
                    <a class="dropdown-item"  target="_empty" href="admin/chart.php">Charts</a> 
                    <a class="dropdown-item"  target="_empty" href="admin/email.php">Email</a> 
                    <a class="dropdown-item"  target="_empty" href="admin/faq.php">FAQ</a> 
                    <a class="dropdown-item"  target="_empty" href="admin/profile.php">Profile</a> 
                    <a class="dropdown-item"  target="_empty" href="admin/tables.php">Tables</a> 
                    <a class="dropdown-item"  target="_empty" href="admin/invoice.php">Invoice</a> 
                  </div>
                </li>
                <li class="nav-item dropdown" >
