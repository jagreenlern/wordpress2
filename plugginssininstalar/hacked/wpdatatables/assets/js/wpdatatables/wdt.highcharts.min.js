...
this.chart=new Highcharts.Chart(this.options);Highcharts.setOptions({lang:{decimalPoint:wpdatatables_settings.wdtNumberFormat==='1'?',':'.',thousandsSep:wpdatatables_settings.wdtNumberFormat==='1'?'.':','}})},setType:function(type){switch(type){case 'highcharts_basic_area_chart':this.options.chart.type='area';break;case 'highcharts_stacked_area_chart':this.options.chart.type='area';this.options.plotOptions={area:{stacking:'normal'}};break;case 'highcharts_basic_bar_chart':this.options.chart.type='bar';break;case 'highcharts_scatter_plot':this.options.chart.type='scatter';break;case 'highcharts_stacked_bar_chart':this.options.chart.type='bar';this.options.plotOptions={series:{stacking:'normal'}};break;case 'highcharts_basic_column_chart':this.options.chart.type='column';break;case 'highcharts_3d_column_chart':this.options.chart.type='column';this.options.chart.margin=75;this.options.chart.options3d={enabled:!0,alpha:15,beta:15,viewDistance:25,depth:40};this.options.plotOptions={column:{depth:25}};break;case 'highcharts_stacked_column_chart':this.options.chart.type='column';this.options.plotOptions={column:{stacking:'normal'}};break;case 'highcharts_pie_chart':this.options.chart.type='pie';this.options.plotOptions={pie:{allowPointSelect:!0,cursor:'pointer',dataLabels:{enabled:!0,format:'<b>{point.name}</b>: {point.percentage:.1f} %',style:{color:(Highcharts.theme&&Highcharts.theme.contrastTextColor)||'black'}}}};this.options.tooltip.pointFormat='{series.name}: <b>{point.percentage:.1f}%</b>'
...
obj.chart=new Highcharts.Chart(obj.options);Highcharts.setOptions({lang:{decimalPoint:wpdatatables_settings.wdtNumberFormat==='1'?',':'.',thousandsSep:wpdatatables_settings.wdtNumberFormat==='1'?'.':','}})}})}};return obj}