    ...
    nextStepButton.click(function (e) {
        ...
        switch (curStep) {
            ...
            case 'step3':
                ...
                test = wdtChartColumnsData;
                $('div.wdt-chart-wizard-chosen-columns-container div.chart-column-block').each(function (i) {
                    for (let j = 0; j < wdtChartColumnsData.length; j++) {
                        if ($(this).data('orig_header') == wdtChartColumnsData[j].orig_header) {
                            constructedChartData.selected_columns[parseInt(wdtChartColumnsData[j].id)] = $(this).data('orig_header');
                        }
                    }
                });
