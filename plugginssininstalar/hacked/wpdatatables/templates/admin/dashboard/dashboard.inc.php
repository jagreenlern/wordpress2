                ...
                <div class="card wdt-changelog-card">
                    ...
                    <div class="card-body card-padding">
                        ...
                        <div class="alert alert-info m-b-0" role="alert">
                            ...
                            <ul>
                                <li class="alert-desc"><?php _e('New fresh admin UI', 'wpdatatables'); ?></li>
                                <li class="alert-desc"><?php _e('New Dashboard page with a lot of useful informations and guides', 'wpdatatables'); ?></li>
                                <li class="alert-desc"><?php _e('New Popup Guide for new users', 'wpdatatables'); ?></li>
                                <li class="alert-desc"><?php _e('New modals like Feature suggestion, Subscriptions and lot more..', 'wpdatatables'); ?></li>
                            </ul>
                        </div>
